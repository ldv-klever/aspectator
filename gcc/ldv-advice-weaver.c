...
static void ldv_store_func_param_list (ldv_i_type_ptr);
...
void
ldv_delete_aux_func_param_list (ldv_i_type_ptr func_type)
{
  ...
  for (param_list = func_type->param
    ...
    ; param_list = ldv_list_get_next (param_list))
    {
      ...
      if (ldv_isvoid (param->type))
        continue;

      /* Mark an auxiliary name for a function parameter as absent. */
      param->name_aux = NULL;
    }
}
  ...
  for (body_c = ldv_get_body_text (body), body_p = 0; *body_c; body_c++, body_p++)
    {
      ...
      /* Find out whether a body arguments weaving is needed. */
      for (body_arg_list = body->ab_arg
        ; body_arg_list
        ; body_arg_list = ldv_list_get_next (body_arg_list))
        {
          ...
          if (body_arg->arg_place == body_p)
            {
              ...
              ldv_print_info (LDV_INFO_WEAVE, "body pattern argument \"%s\" was weaved", func_arg);
            }
        }

      /* Find out whether a body arguments types weaving is needed. */
      for (body_arg_list = body->ab_arg_type
        ; body_arg_list
        ; body_arg_list = ldv_list_get_next (body_arg_list))
        {
          body_arg = (ldv_ab_arg_ptr) ldv_list_get_data (body_arg_list);
          ...
          if (body_arg->arg_place == body_p)
            {
              ...
              ldv_print_info (LDV_INFO_WEAVE, "body pattern argument type name \"%s\" was weaved", func_arg);
            }
        }

      /* Find out whether a body arguments sizes weaving is needed. */
      for (body_arg_list = body->ab_arg_size
        ; body_arg_list
        ; body_arg_list = ldv_list_get_next (body_arg_list))
        {
          body_arg = (ldv_ab_arg_ptr) ldv_list_get_data (body_arg_list);
          ...
          if (body_arg->arg_place == body_p)
            {
              ...
              if (func_arg_size == -1)
                {
                  ...
                  ldv_print_info (LDV_INFO_WEAVE, "generate stub \"-1\" for body pattern argument size");
                }
              else
                {
              ...
              ldv_print_info (LDV_INFO_WEAVE, "body pattern argument size \"%s\" was weaved", func_arg);
            }
        }

      /* Find out whether a body arguments values weaving is needed. */
      for (body_arg_list = body->ab_arg_value
        ; body_arg_list
        ; body_arg_list = ldv_list_get_next (body_arg_list))
        {
          body_arg = (ldv_ab_arg_ptr) ldv_list_get_data (body_arg_list);
              ...
              if (func_arg == 0)
                {
                  ...
                  ldv_print_info (LDV_INFO_WEAVE, "generate stub \"0\" for body pattern argument value");
                }
              else
                ldv_puts_text (func_arg, body_with_patterns);

              ldv_print_info (LDV_INFO_WEAVE, "body pattern argument value \"%s\" was weaved", func_arg);
            }
        }

      /* Find out whether an aspect function name weaving is needed. */
      for (body_place_list = body->ab_aspect_func_name
        ; body_place_list
      ...
      /* Find out whether a function name weaving is needed. */
      for (body_place_list = body->ab_func_name
        ; body_place_list
        ; body_place_list = ldv_list_get_next (body_place_list))
        {
          body_general = (ldv_ab_general_ptr) ldv_list_get_data (body_place_list);
      ...
      /* Find out whether a proceeds weaving is needed. */
      for (body_place_list = body->ab_proceed
        ; body_place_list
        ; body_place_list = ldv_list_get_next (body_place_list))
        {
          body_general = (ldv_ab_general_ptr) ldv_list_get_data (body_place_list);
          ...
          if (body_general->arg_place == body_p)
            {
              ...
              ldv_print_info (LDV_INFO_WEAVE, "body pattern proceed \"%s\" was weaved", func_call);
            }
        }

      /* Find out whether a results weaving is needed. */
      for (body_place_list = body->ab_res
        ; body_place_list
        ; body_place_list = ldv_list_get_next (body_place_list))
        {
          body_general = (ldv_ab_general_ptr) ldv_list_get_data (body_place_list);
          ...
          if (body_general->arg_place == body_p)
            {
              ...
              ldv_print_info (LDV_INFO_WEAVE, "body pattern result \"%s\" was weaved", LDV_FUNC_RES);
            }
        }

      /* Find out whether a return type weaving is needed. */
      for (body_place_list = body->ab_ret_type
        ; body_place_list
        ; body_place_list = ldv_list_get_next (body_place_list))
        {
          body_general = (ldv_ab_general_ptr) ldv_list_get_data (body_place_list);
          ...
          if (body_general->arg_place == body_p)
            {
              ...
              ldv_print_info (LDV_INFO_WEAVE, "body pattern return type \"%s\" was weaved", LDV_FUNC_RET_TYPE);
            }
        }
    }
...
void
ldv_store_func_param_list (ldv_i_type_ptr func_type)
{
  ldv_i_param_ptr param = NULL;
  ldv_list_ptr param_list = NULL;
  const char *param_name = NULL;
  ldv_id_ptr param_name_aux;
  const char *param_name_numb_aux = NULL;
  ...
  /* Walk through function parameters. */
  for (param_list = func_type->param, param_numb = 1
    ; param_list || isva
    ; param_list = (param_list == NULL) ? NULL : ldv_list_get_next (param_list), param_numb++, param_name = NULL)
    {
      if (param_list)
        {
          param = (ldv_i_param_ptr) ldv_list_get_data (param_list);
          ...
          /* Use an existing parameter name if so. */
          if (param->name)
            param_name = param->name;
        }

      /* If no name was specified at the moment then generate an auxiliary name
      ...
      if (!param_name)
        {
          ...
          param_name_numb_aux = ldv_itoa (param_numb);

          ldv_puts_id (param_name_numb_aux, param_name_aux);
      ...
      ldv_list_push_back (&ldv_func_param_list, str);

      /* Generate the only auxiliary parameter name for the ellipsis. */
      if (isva)
        isva = false;

      if (param_list && param->type->isva)
        isva = true;
    }
}
      ...
      if (ldv_isldv_stage_third ())
        {
          ...
          /* Function parameters names are obtained on the basis of a source
          ...
          ldv_delete_aux_func_param_list (func_aspect->type);
      ...
      if (ldv_isldv_stage_third ())
        {
          ...
          param_new->name = LDV_VAR_ARG_NAME;
          ...
          ldv_store_func_param_list (func_aspect->type);
